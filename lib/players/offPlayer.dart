...
class OffPlayer extends StatefulWidget {
  String tit;
  String vdo;
  OffPlayer({this.tit, this.vdo});
  @override
  State<StatefulWidget> createState() {
    return _OffPlayerState(tit, vdo);
  }
}

class _OffPlayerState extends State<OffPlayer> {
  String tit;
  String vdo;
  _OffPlayerState(this.tit, this.vdo);
