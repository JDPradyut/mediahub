...
class CatSer extends StatefulWidget {
  final String where;
  final String isEqual;
  CatSer({this.where, this.isEqual});

  @override
  _CatSerState createState() => _CatSerState(this.where, this.isEqual);
}

class _CatSerState extends State<CatSer> {
  String where;
  String isEqual;
  _CatSerState(this.where, this.isEqual);
