...
class CatMov extends StatefulWidget {
  final String where;
  final String isEqual;
  CatMov({this.where, this.isEqual});

  @override
  _CatMovState createState() => _CatMovState(this.where, this.isEqual);
}

class _CatMovState extends State<CatMov> {
  String where;
  String isEqual;
  _CatMovState(this.where, this.isEqual);
