...
class TrdMoviesWidget extends StatefulWidget {
  @override
  _TrdMoviesWidgetState createState() => _TrdMoviesWidgetState();
}

class _TrdMoviesWidgetState extends State<TrdMoviesWidget> {
